...
\begin{quote}
{[}!EXAMPLE{]} \textbf{\emph{Example 3.2}}
...
\begin{quote}
{[}!EXAMPLE{]} \textbf{\emph{Example 3.3}}
...
\begin{quote}
{[}!EXAMPLE{]} \textbf{\emph{Example 6.2}}
...
\begin{quote}
{[}!EXAMPLE{]} Calculate the z-transform of these signals:
...
\begin{quote}
{[}!NOTE{]} \textbf{\emph{Table 1 Characteristic Families of Signals
with Their Corresponding ROCs}}
...
\begin{quote}
{[}!NOTE{]} \textbf{\emph{Table 2 Properties of the z-Transform}}
...
\begin{quote}
{[}!NOTE{]} \textbf{\emph{Table 3 Some Common z-Transform Pairs}}
